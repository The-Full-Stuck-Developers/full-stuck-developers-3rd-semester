...
import {CircleSlash, SquarePen, Trash2, UserPlus, UserX} from "lucide-react";
                ...
                <div
                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-body">
                        ...
                        <tr className={"px-2 bg-gray-700"}>
                            <th scope="col"
                                className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider rounded-tl-xl">Week
                            </th>
                            <th scope="col"
                                className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Year
                            </th>
                            <th scope="col"
                                className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Start
                                Time
                            </th>
                            <th scope="col"
                                className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Revenue
                            </th>
                            <th scope="col"
                                className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Winning
                                Numbers
                            </th>

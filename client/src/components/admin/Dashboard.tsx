    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 text-white">
                <div className="bg-gray-800 hover:bg-gray-700 rounded-2xl p-6 border border-gray-700 cursor-pointer"
                ...
                <div className="bg-gray-800 hover:bg-gray-700 rounded-2xl p-6 border border-gray-700 cursor-pointer"
                    ...
                    <p className="text-sm text-gray-400">{t('navigate_to_this_week_game_details')}</p>
                </div>
            </div>
        </div>
    );

  ...
  return (
    <div>
      ...
      <div className={"flex flex-row items-center justify-between w-full pb-8"}>
        <div className={"flex flex-col items-baseline"}>
          <p className={"text-white text-3xl mb-2 mx-0 p-0"}>
            {t("game:game_details")} - {t("week")} {game?.weekNumber} /{" "}
            {game?.year}
          </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 text-white">
        <div className="bg-gray-800 rounded-2xl p-5 border border-gray-700 flex flex-col items-baseline justify-between">
        ...
        <div className="bg-gray-800 rounded-2xl p-5 border border-gray-700 flex flex-col items-baseline justify-between">
          <div className={"w-full"}>
            ...
            <div>
              Jerne IF: {game?.revenue * 0.3} dkk / Players:{" "}
        ...
        <div className="bg-gray-800 rounded-2xl p-5 border border-gray-700 flex flex-col items-baseline justify-between">
          ...
          <div>
            ...
            {game?.numberOfPhysicalPlayers ?? 0}
          </div>

...
import {ChevronsDown, Dice5, GamepadIcon, LayoutDashboard, Users, Wallet} from "lucide-react";
...
export const SidebarLayout: React.FC = () => {
    ...
    return (
        <div className="w-full h-screen overflow-hidden bg-gray-900">
            {/*Header*/}
            <nav
                className="navbar fixed top-0 left-0 right-0 z-50 bg-gray-800 backdrop-blur-lg h-[72px] flex items-center">

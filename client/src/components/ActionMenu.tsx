              ...
              >
                {actions.map((action, i) =>
                  "separator" in action ? (
                    ...
                    >
                      <div className="w-4 h-4 flex items-center justify-center me-2">
                        {action.icon}
                      </div>
                      <span style={{ color: action.color ?? "#000000" }}>
                        {action.label}
                      </span>
                    </button>
                  ),
        ...
        >
          ...
          >
            <div className="flex items-start mb-4">
              <div className="shrink-0 w-10 h-10 rounded-full bg-amber-100 flex items-center justify-center mr-3">

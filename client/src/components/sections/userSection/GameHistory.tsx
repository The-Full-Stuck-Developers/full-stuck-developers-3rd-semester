...
const gameHistory = [
    { week: 23, date: "8.–15. jun. 2024", winning: [2, 7, 14], boards: 2, won: true, prize: "1.250,00 kr." },
    { week: 22, date: "1.–8. jun. 2024", winning: [5, 11, 3], boards: 1, won: false },
    { week: 20, date: "18.–25. maj 2024", winning: [1, 8, 13], boards: 2, won: false },
    { week: 20, date: "18.–25. maj 2024", winning: [1, 8, 13], boards: 2, won: false },
                    ...
                    >
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-4">
                                <div className={`p-3 rounded-xl ${game.won ? "bg-green-900/40" : "bg-gray-700"}`}>
                                    {game.won ? (
                            ...
                            <div className="text-right">
                                <div className="text-2xl font-black">{game.boards} board{game.boards > 1 && "s"}</div>
                                {game.won && (
                                    <div className="text-green-400 font-bold text-lg mt-1">Won {game.prize}</div>
                                )}
                            </div>
                        </div>
                                ...
                                {game.winning.map((num) => (
                                    <div
                                        ...
                                        className={`w-12 h-12 rounded-lg flex items-center justify-center font-mono text-lg font-bold ${
                                            game.won ? "bg-green-600 text-white" : "bg-gray-700 text-gray-300"
                                        }`}
                                    >

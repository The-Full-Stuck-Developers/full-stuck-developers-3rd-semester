                ...
                >
                    <div className="p-6 flex flex-col h-full">
                        ...
                        <nav className="space-y-1 flex-1">
                            <p className="text-xs uppercase text-gray-500 font-medium mb-3">My Games</p>
                            {navItems.map((item) => (
                                <Link
                                    key={item.to}
                                    to={item.to}
                        ...
                        <div className="mt-auto space-y-6">
                            <div className="flex items-center gap-3 p-4 bg-gray-700/50 rounded-xl">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="font-medium truncate">Jens Petersen</div>
                                    <div className="text-xs text-gray-400 truncate">+45 1234 5678</div>
                                </div>

  ...
  return (
    <section className="w-full bg-[#0f2b5b] py-24 lg:py-32 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 text-center">
        <h2 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white tracking-tighter uppercase">
          {t("home:ready_to_support")} <br className="hidden sm:block" />
          <span className="text-[#e30613]">JERNE IF?</span>
        </h2>

        <p className="mt-6 text-xl sm:text-2xl text-white/90 font-medium max-w-3xl mx-auto">
          {t("home:join_and_help_us_grow")}
        </p>
        ...
        <p className="mt-10 text-lg text-white/80">{t("home:questions")}</p>
      </div>
    </section>
  );
}

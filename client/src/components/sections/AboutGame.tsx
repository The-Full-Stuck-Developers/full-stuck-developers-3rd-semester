            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="group relative bg-white rounded-3xl border-2 border-[#0f2b5b]/10 shadow-lg hover:shadow-2xl hover:border-[#e30613] transition-all duration-300 p-10 text-center">
                        ...
                        <Wallet size={68} className="text-[#e30613] mx-auto mb-6 group-hover:scale-110 transition-transform" />
                        <h3 className="text-2xl font-bold text-[#0f2b5b] mb-4">Add Balance</h3>
                    ...
                    <div className="group relative bg-white rounded-3xl border-2 border-[#0f2b5b]/10 shadow-lg hover:shadow-2xl hover:border-[#e30613] transition-all duration-300 p-10 text-center">
                        ...
                        <Grid size={68} className="text-[#e30613] mx-auto mb-6 group-hover:scale-110 transition-transform" />
                        <h3 className="text-2xl font-bold text-[#0f2b5b] mb-4">Pick Numbers</h3>
                        <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="group relative bg-white rounded-3xl border-2 border-[#0f2b5b]/10 shadow-lg hover:shadow-2xl hover:border-[#e30613] transition-all duration-300 p-10 text-center">
                        ...
                        <RefreshCw size={68} className="text-[#e30613] mx-auto mb-6 group-hover:scale-110 transition-transform" />
                        <h3 className="text-2xl font-bold text-[#0f2b5b] mb-4">Play Weekly</h3>
                        <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="group relative bg-white rounded-3xl border-2 border-[#0f2b5b]/10 shadow-lg hover:shadow-2xl hover:border-[#e30613] transition-all duration-300 p-10 text-center">
                        ...
                        <Trophy size={68} className="text-[#e30613] mx-auto mb-6 group-hover:scale-110 transition-transform" />
                        <h3 className="text-2xl font-bold text-[#0f2b5b] mb-4">Win Prizes</h3>
                        <p className="text-gray-600 leading-relaxed">

      ...
      <div className="max-w-7xl mx-auto px-6 py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative rounded-full flex items-center px-2 py-2 gap-2 w-28 h-13 mx-auto border-2 border-white/30 hover:bg-white/10 hover:border-white transition-all m-0">
              <div
                className={`absolute h-8 w-11 bg-white/20 rounded-full shadow-lg transition-all duration-300 ${
                  lang === "en" ? "left-2" : "left-[calc(100%-2.75rem-0.5rem)]"
                }`}
              />
              <button
